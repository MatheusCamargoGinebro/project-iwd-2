...
--
-- Host: localhost    Database: theIfers
-- ------------------------------------------------------
...
CREATE TABLE `card` (
  ...
  `cardImageURL` varchar(1024) DEFAULT NULL,
  `data_armazenamento` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `cardId` int NOT NULL AUTO_INCREMENT,
  KEY `cardId` (`cardId`),
  CONSTRAINT `card_ibfk_1` FOREIGN KEY (`cardId`) REFERENCES `userSite` (`id`)
...
-- Dump completed on 2023-06-18 13:54:15
